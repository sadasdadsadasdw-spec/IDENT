...
Система прошла все критерии приемки:
- ✓ Создание/обновление записей
- ✓ Конвертация лидов
- ✓ Определение филиала (100% точность)
- ✓ Отображение планов лечения
...
### Этап 1: Разработка и тестирование (30 дней)
- [x] Модуль извлечения данных
- [x] Модуль преобразования
- [x] Модуль отправки в API
- [x] Модуль логирования
- [x] Модуль очередей
- [x] Локальное приложение
- [x] Интеграционное тестирование

### Этап 2: Пилотное внедрение (15 дней)
- [ ] Подготовка пилотного филиала
...
### Этап 3: Промышленная эксплуатация (15 дней)
- [ ] Развертывание на всех филиалах
- [ ] Обучение всех кураторов
- [ ] Мониторинг
- [ ] Приемочные испытания

**Общий срок:** 55 рабочих дней

## Документация

- [Техническое задание](docs/TZ.md) - полное ТЗ проекта
- [Спецификация требований](docs/REQUIREMENTS.md) - детальные требования
- [Схемы маппинга данных](docs/MAPPING.md) - соответствие полей Ident ↔ Битрикс24
- [Руководство администратора](docs/ADMIN_GUIDE.md) - установка, настройка, обслуживание
- [Руководство пользователя](docs/USER_GUIDE.md) - для кураторов лечения
- [API документация](docs/API.md) - REST API для планов лечения

## Ограничения

- Синхронизация односторонняя (Ident → Битрикс24)
- Не синхронизируются файлы и медиа-контент
- Исторические данные: только за последние 7 дней при первом запуске
- Лимит API Битрикс24: 2 запроса/сек (зависит от тарифа)
